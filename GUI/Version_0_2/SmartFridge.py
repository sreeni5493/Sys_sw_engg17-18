...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_19.setGeometry(QtCore.QRect(17, 17, 511, 51))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_translate("Form", "Image resolution", None))
        self.label_6.setText(_translate("Form", "Vegetables", None))
        self.label_7.setText(_translate("Form", "Condition of vegetables", None))
        ...
        self.comboBox.setItemText(0, _translate("Form", "Bananas", None))
        self.comboBox.setItemText(1, _translate("Form", "Tomatoes", None))
        self.comboBox.setItemText(2, _translate("Form", "Both ", None))
        self.comboBox_2.setItemText(0, _translate("Form", "Fresh", None))
        self.comboBox_2.setItemText(1, _translate("Form", "Rotten", None))
        self.comboBox_2.setItemText(2, _translate("Form", "Both", None))
        self.label_19.setText(_translate("Form", "Frontend for SmartFridge input images simulation with a lot of good looking sliders.", None))
