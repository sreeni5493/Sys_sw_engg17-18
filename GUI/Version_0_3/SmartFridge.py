...
class Ui_SmartFridge(object):
    def setupUi(self, SmartFridge):
        ...
        self.actionClose = QtGui.QAction(SmartFridge)
        ...
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), self.open_directory)
    ...
    def retranslateUi(self, SmartFridge):
        ...
        self.radioButton_2.setText(_translate("SmartFridge", "Banana", None))
        self.radioButton_3.setText(_translate("SmartFridge", "Tomato", None))
        self.radioButton.setText(_translate("SmartFridge", "Both", None))
        self.checkBox_1.setText(_translate("SmartFridge", "0", None))
        self.checkBox_3.setText(_translate("SmartFridge", "1", None))
        self.checkBox_4.setText(_translate("SmartFridge", "2", None))
        self.checkBox_5.setText(_translate("SmartFridge", "3", None))
        self.label_12.setText(_translate("SmartFridge", "Number of images", None))
        self.toolButton_2.setText(_translate("SmartFridge", "?", None))
        self.label_7.setText(_translate("SmartFridge", "Degree of decay", None))
        self.toolButton_3.setText(_translate("SmartFridge", "?", None))
        self.label_6.setText(_translate("SmartFridge", "Number of fruits per image", None))
        self.toolButton_5.setText(_translate("SmartFridge", "?", None))
        self.label_3.setText(_translate("SmartFridge", "Kinds of fruits", None))
        self.toolButton_6.setText(_translate("SmartFridge", "?", None))
        self.label_4.setText(_translate("SmartFridge", "Resolution", None))
        self.toolButton_8.setText(_translate("SmartFridge", "?", None))
        self.label.setText(_translate("SmartFridge", "Path to the database", None))
        self.toolButton_10.setText(_translate("SmartFridge", "?", None))
        self.label_5.setText(_translate("SmartFridge", "x", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("SmartFridge", "Standard view", None))
        self.label_8.setText(_translate("SmartFridge", "Camera position  ", None))
        self.toolButton_11.setText(_translate("SmartFridge", "?", None))
        self.label_9.setText(_translate("SmartFridge", "  X-axis  ", None))
        self.label_10.setText(_translate("SmartFridge", "  Y-axis  ", None))
        self.label_11.setText(_translate("SmartFridge", "  Z-axis  ", None))
        self.label_13.setText(_translate("SmartFridge", "Lightning  ", None))
        self.toolButton_13.setText(_translate("SmartFridge", "?", None))
        self.label_14.setText(_translate("SmartFridge", "Background color  ", None))
        self.toolButton_14.setText(_translate("SmartFridge", "?", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("SmartFridge", "Expert view", None))
        ...
        self.actionClose.setText(_translate("SmartFridge", "Quit", None))
