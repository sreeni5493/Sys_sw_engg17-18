...
class Ui_SudokuSolver(object):
    def setupUi(self, SudokuSolver):
        ...
        self.checkBox_1 = QtGui.QCheckBox(self.groupBox_2)
        self.checkBox_1.setObjectName(_fromUtf8("checkBox_1"))
        self.gridLayout_2.addWidget(self.checkBox_1, 0, 8, 1, 1)
        ...
        self.toolButton_81 = QtGui.QToolButton(self.gridWidget)
        self.toolButton_81.setEnabled(True)
        font = QtGui.QFont()
        font.setPointSize(6)
        font.setBold(True)
        font.setItalic(True)
        ...
        self.toolButton_81.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.toolButton_81.setPopupMode(QtGui.QToolButton.DelayedPopup)
        self.toolButton_81.setToolButtonStyle(QtCore.Qt.ToolButtonFollowStyle)
        self.toolButton_81.setAutoRaise(True)
        self.toolButton_81.setArrowType(QtCore.Qt.NoArrow)
        self.toolButton_81.setObjectName(_fromUtf8("toolButton_81"))
        self.verticalLayout_9.addWidget(self.toolButton_81)
    ...
    def retranslateUi(self, SudokuSolver):
        ...
        self.checkBox_4.setText(_translate("SudokuSolver", "Frontal view", None))
        ...
        self.checkBox_1.setText(_translate("SudokuSolver", "New Sudoku puzzle", None))
        self.checkBox_1.toggled.connect(self.CB1_checked)
        ...
        self.toolButton_81.setText(_translate("SudokuSolver", "i", None))
...
############# POPUPS
        ...
        self.toolButton_81.pressed.connect(self.info_popup_2)
...
################# POPUP MESSAGES DEF
    ...
    def info_popup_8(self):
        ppa = QtGui.QWidget()
        result = QtGui.QMessageBox.information(ppa,'Informatin','At the moment two tasks implemented \nsimulations for SudokuSolver and SmartFridge.')
        """
    ...
    def generate_clicked(self):
        ...
        s = sudoku_class.Sudoku(self.lEd, self.dif, self.CB2, self.cms ,self.sB1, self.sB2, self.CB4, self.sB4, self.CB1 , self.CB3)        
        s.create()
